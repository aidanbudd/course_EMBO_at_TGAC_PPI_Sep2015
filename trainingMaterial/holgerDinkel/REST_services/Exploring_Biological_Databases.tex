...
%        \end{block}}
        \begin{center}
            \only<1|handout:1>{\optional{\includegraphics[width=.9\textwidth]{images/Uniprot_Search_Abl.png}}}%
            \only<2|handout:0>{\optional{\includegraphics[width=.95\textwidth]{images/Uniprot_Download.png}}}%
