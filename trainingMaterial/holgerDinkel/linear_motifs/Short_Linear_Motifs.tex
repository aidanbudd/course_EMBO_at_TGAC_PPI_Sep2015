...
\begin{frame}\frametitle{Importance of Short Linear Motifs: Diseases}
...
%        \PROT{SANS} protein.
%        }}%
        \vspace{4em} \tiny{See \url{http://elm.eu.org/infos/diseases.html} for a list of motifs implicated in various diseases.}%
    \end{frame}
