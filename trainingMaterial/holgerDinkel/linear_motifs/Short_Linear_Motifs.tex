...
%        \vspace{-1.25em}%
        \vfill \only<1-2|handout:1>{\hogsboxtop{Liddle's-Syndrome: WW-Interaction motif}{%
        ...
        %  \vspace{1em}%
        \visible<2|handout:1>{\hogsboxtop{Bacillus anthracis ``lethal factor''}{%
                The protein \PROT{LEF\_BACAN} is a metalloprotease (one of the three proteins composing the anthrax toxin) that specifically
...
%        \PROT{SANS} protein.
%        }}%
        \vspace{0.4em} \tiny{See \url{http://elm.eu.org/infos/diseases.html} for a list of motifs implicated in various diseases.}%
    \end{frame}
        ...
        \begin{minipage}[\textheight]{\textwidth}
            \begin{columns}[T]
                ...
                \begin{column}{0.7\textwidth}
                    \vspace{2mm}The most recurrently mutated experimentally validated motif in the COSMIC DB
                    is the conserved proteasomal degradation motif (DEG\_SCF\_TRCP1\_1)in the highly disordered N-terminal
