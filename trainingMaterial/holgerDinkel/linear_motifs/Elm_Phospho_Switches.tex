...
\begin{frame}[t]\frametitle{\insertsubsection{}}%
    ...
    \note{my Job: Improving the user interface and implementing new methods}%
        \visible<1->{\vspace{-2mm}
            \optional{\includegraphics[width=.8\textwidth]{images/elm/elm_title.jpg}}\\\vspace{-8mm}%
        \hogsboxtop{The \includegraphics[width=1cm]{elm_logo_transparent.png}~resource}{is a collection of nearly 200 thoroughly annotated motif
        classes with over 2400 annotated instances. \\
